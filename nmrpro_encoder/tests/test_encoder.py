...
from nmrpro_encoder.encoder import pngSpecEncoder
from PIL import Image
from io import BytesIO

class pngEncoder_1DTest(unittest.TestCase):
    def setUp(self):
        self.spec1d = fromBruker("../nmrpro/test_files/Bruker_1D/")
...
class pngEncoder_2DTest(unittest.TestCase):
    def setUp(self):
        self.spec2d = fromPipe("../nmrpro/test_files/Pipe_2D/tocsy.ft2")
